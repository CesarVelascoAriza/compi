...
import co.ucentral.edu.analizadores.AnalizadorCondicional;
import co.ucentral.edu.analizadores.AnalizadorMientras;
import co.ucentral.edu.analizadores.AnalizarOperacion;
...
public class FrameSCorte extends javax.swing.JFrame {
	...
	private AnalizarOperacion analizarOperacion;
	private AnalizadorCondicional analizadorCondicional; 
	public FrameSCorte() {
		initComponents();
		lexico = new Lexico();
		...
		analizarOperacion = new AnalizarOperacion();
		analizadorCondicional = new AnalizadorCondicional();
	}
	...
	private void initComponents() {
		...
		jPanelArchivoLayout
				.setHorizontalGroup(
						jPanelArchivoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanelArchivoLayout.createSequentialGroup().addContainerGap()
										.addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 81,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(txfRutaArchivo, javax.swing.GroupLayout.PREFERRED_SIZE, 211,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(btnArchivo, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addContainerGap()));
		jPanelArchivoLayout.setVerticalGroup(jPanelArchivoLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelArchivoLayout.createSequentialGroup().addGap(17, 17, 17)
						.addGroup(jPanelArchivoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel1)
								.addComponent(txfRutaArchivo, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(51, 51, 51).addComponent(btnLimpiar)
						.addGap(44, 44, 44).addComponent(btnAnalizar).addGap(43, 43, 43).addComponent(btnEjecutar)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel1Layout.createSequentialGroup().addContainerGap(12, Short.MAX_VALUE)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(btnLimpiar).addComponent(btnAnalizar).addComponent(btnEjecutar))
								.addContainerGap()));
		...
		jPanelTexAreaLayout
				.setHorizontalGroup(jPanelTexAreaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelTexAreaLayout.createSequentialGroup().addContainerGap()
								.addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)
								.addContainerGap()));
		jPanelTexAreaLayout.setVerticalGroup(
				jPanelTexAreaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						jPanelTexAreaLayout.createSequentialGroup().addContainerGap()
								.addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
								.addGap(7, 7, 7)));

		jPanelTabla.setMaximumSize(new java.awt.Dimension(327679, 32767));

		tbSimbolos.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null, null, null } },
				new String[] { "Palabra", "Liena", "Tipo" }));
		tablaSimbolos.setViewportView(tbSimbolos);

		javax.swing.GroupLayout jPanelTablaLayout = new javax.swing.GroupLayout(jPanelTabla);
		jPanelTabla.setLayout(jPanelTablaLayout);
		jPanelTablaLayout
				.setHorizontalGroup(jPanelTablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelTablaLayout.createSequentialGroup().addContainerGap()
								.addComponent(tablaSimbolos, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
								.addContainerGap()));
		jPanelTablaLayout
				.setVerticalGroup(jPanelTablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelTablaLayout.createSequentialGroup().addContainerGap()
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jPanelTabla, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(jPanelArchivo, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(layout.createSequentialGroup()
								.addComponent(jPanelTexArea, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addComponent(jPanelArchivo, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addComponent(jPanelTabla, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap())
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	...
	private void btnEjecutarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEjecutarActionPerformed
		...
		if (!okSintactico) {
			...
			boolean existeMientras = false;
			boolean ExisteSi = false;
			for (int i = 1; i < listLinea.size(); i++) {
				...
				if (!p.getTipo().equals("IDENTIFICADOR")) {
					...
					case "si":
						...
						break;
					case "mientras":
						// mientras.analizarLinea(analizaLinea);
						existeMientras = true;
						System.out.println("Prueba " + analizaLinea + linea);
					...
					analizarOperacion.setSemantico(semantico);
					analizarOperacion.analizarLineaEjecucion(analizaLinea);
					linea++;
				}
			}

			if (!ExisteSi && !existeMientras) {
				linea = 1;
			...
			if (existeMientras) {
				int linea2 = 1;
				while (listLinea.size() > linea2) {
					analizaLinea = listLinea.get(linea2);
					palabra = semantico.tablaSimbolos(analizaLinea, linea2);

					// p=palabra.get(0);
					System.out.println(analizaLinea);
					mientras.analizarLinea(analizaLinea);
				...
				mientras.setSemantico(semantico);
				mientras.analizarCondicion();
			}
			if (ExisteSi) {
				linea = 1;
				...
				for (int i = 1; i < listLinea.size(); i++) {
					...
					if (!p.getTipo().equals("IDENTIFICADOR")) {
						...
						case "escriba":
							...
							if(analizadorCondicional.getLinea().isEmpty()) {
								System.out.println(analizadorCondicional.getLinea().isEmpty());
								
								semantico.analizadorEscriba(analizaLinea, linea);
								tAreaRanalisis.setText(tAreaRanalisis.getText() + "\n" + semantico.gettAEscriba());
								
							}else if(!analizadorCondicional.getLinea().isEmpty() ){
								if(analizadorCondicional.analizacondicion()) {
								semantico.analizadorEscriba(analizaLinea, linea);
								tAreaRanalisis.setText(tAreaRanalisis.getText() + "\n" + semantico.gettAEscriba());
								}
							}
						...
						case "lea":
							...
							break;
						case "si":
							analizadorCondicional.setLinea(analizaLinea);
							analizadorCondicional.setSemantico(semantico);
							linea++;
							break;
						case "sin":
							linea++;
				...
				System.out.println("termino el wile");
			}
...
//                ArrayList<Palabra> listaPalabras = new ArrayList<>();
				...
				if (!lexico.getAutomata().getErrorSintactico().isEmpty()) {
					for (int i = 0; i < lexico.getAutomata().getErrorSintactico().size(); i++) {
						tAreaRanalisis
								.setText(lexico.getAutomata().getErrorSintactico().get(i).getDescripcion() + "\n");
					}
				} else {
				...
				tbSimbolos.setModel(new javax.swing.table.DefaultTableModel(mostrarTabla,
						new String[] { "Nombre", "Linea", "Tipo" }));
			} else {
				JOptionPane.showMessageDialog(null, "No se ha seleccionado Ningun archivo", "Text area vacia",
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(FrameSCorte.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
